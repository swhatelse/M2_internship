...
# CMD="CLPLATFORM=NVIDIA VERBOSE=true OPTIMIZER_LOG_FILE=$DATA_FILE OPTIMIZER_LOG=true ruby Laplacian.rb -c"
CMD="CLPLATFORM=NVIDIA VERBOSE=true ruby Laplacian.rb -c"

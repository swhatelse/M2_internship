...
- The application developer has to specify how to take into account
...
:BEAMER_act: <3>
:END:
# #+LaTeX: \begin{overlayarea}{\linewidth}{0cm}\vspace{-4.0cm}\begin{block}{}
...
****** BOAST
  ...
  - Complete tool chain: code generation, verification, compilation, benchmark
...
- Based on:
  - Design of experiments \to question the search at a minimal
    experimental cost
  - Regression techniques \to interpreting information to make appear
...
3. Instantiate the model to predict best values for fixed significant
   parameters
...
* Conclusion
*** Summary
- We design a new approach that put the user in the center of the

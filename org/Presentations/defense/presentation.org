...
- Presents a code that the compiler can easily work with \to less burden for
  the developer
- Allows to specify the type of transformation wanted 
...
- BOAST:
  ...
  - Complete tool chain:
    ...
    - Benchmark
*** Problem analysis
- With all this tools it is easy to generate different variant of the
  same code but with different \to How to find the best versions?
...
\begin{figure}[t]
\centering
\includegraphics[width=.65\linewidth]{./img/results_hist.pdf}
\end{figure}
#+END_LaTeX

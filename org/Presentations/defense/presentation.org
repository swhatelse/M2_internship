...
- Based on:
  - Design of experiments \to question the search
  - Regression techniques \to interpreting information
...
- Dig sampling strategy to reduce even more the number of points.
*** This is the end

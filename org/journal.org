...
*** Deploying an environment
    ...
    #+begin_src sh :results output :exports both
      kadeploy3 -e environment -f $OAR_FILE_NODES -k
    #+end_src
*** Connection:
     #+begin_src sh :results output :exports both
       ssh root@node
...
** 2016-02-16
   ...
   #+end_src
   - Get experiment environment:
     #+begin_src sh :results output :exports both :tangle scripts/run_xp.sh
       #!/bin/bash
       BASE="$PWD/../.."
       DATADIR="$BASE/org/data"
       ...
       mv $DATA_FILE'.yaml' $DATADIR/$DATAFOLD
       mv $DATA_FILE_paremeters'.yaml' $DATADIR/$DATAFOLD
   #+end_src
   ...
   - Bruteforce Adonis:
       #+begin_src sh :results output :exports both :tangle scripts/bruteforce_adonis.sh
         ...
         mv $DATA_FILE_paremeters'.yaml' $DATAFOLD2 
       #+end_src

...
**** Take a look at rq
     For now I have some difficult to substitue correctly the argument
     of the function. I am extracting the code outside of the function
     because I can more easily explode and explore the code.
     #+begin_src R :results output :session :exports both
       library(quantreg)
       data(engel)
       data = engel
       ...
       ###################################
       call <- call("whocares", formula = foodexp ~ income, data = engel)
       mf <- call("whocares", formula = foodexp ~ income, data = engel, expand.dots = FALSE)

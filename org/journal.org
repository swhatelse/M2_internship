...
* TODO [6/9]
  ...
  - [ ] Take a look to statistic of extreme events and minimum estimtation
* Memo
  - Get opencl platform
...
*** Backsolve error
    - With Angelika we found that the problem came from the fact the
      time_per_pixel data are not linear
       #+begin_src sh :results output :exports both
         ruby scripts/format_data.rb data/2016_03_11/pilipili2/19_13_54/Data19_13_54_linear.yaml
       #+end_src
      ...
      #+begin_src R :results output :session :exports both
        library("quantreg")
        df <- read.csv("/tmp/test.csv",strip.white=T,header=T)
        df$linear_time_per_pix <- log(df$time_per_pixel)

        regq = rq(data=df, formula = linear_time_per_pix ~ x_component_number, tau=.05, method="fn")
        regq;
        summary(regq,se="nid")
      #+end_src
      ...
      #+begin_example
      Call:
      rq(formula = linear_time_per_pix ~ x_component_number, tau = 0.05, 
          data = df, method = "fn")
      ...
      Call: rq(formula = linear_time_per_pix ~ x_component_number, tau = 0.05, 
          data = df, method = "fn")
...
#+end_example
      ...
      #+begin_src R :results output :session :exports both
                plot(df$x_component_number,df$linear_time_per_pix)
        str(regq)
                abline(regq, col=2)
      #+end_src
      ...
      #+begin_example
       ...
       $ terms        :Classes 'terms', 'formula' length 3 linear_time_per_pix ~ x_component_number
        .. ..- attr(*, "variables")= language list(linear_time_per_pix, x_component_number)
        .. ..- attr(*, "factors")= int [1:2, 1] 0 1
        .. .. ..- attr(*, "dimnames")=List of 2
        .. .. .. ..$ : chr [1:2] "linear_time_per_pix" "x_component_number"
        .. .. .. ..$ : chr "x_component_number"
        .. ..- attr(*, "term.labels")= chr "x_component_number"
        .. ..- attr(*, "order")= int 1
        .. ..- attr(*, "intercept")= int 1
        .. ..- attr(*, "response")= int 1
        .. ..- attr(*, ".Environment")=<environment: R_GlobalEnv> 
        .. ..- attr(*, "predvars")= language list(linear_time_per_pix, x_component_number)
        .. ..- attr(*, "dataClasses")= Named chr [1:2] "numeric" "numeric"
        .. .. ..- attr(*, "names")= chr [1:2] "linear_time_per_pix" "x_component_number"
       $ xlevels      : Named list()
       $ call         : language rq(formula = linear_time_per_pix ~ x_component_number, tau = 0.05, data = df,      method = "fn")
       $ rho          : num 70.1
       $ method       : chr "fn"
       $ model        :'data.frame':	2000 obs. of  2 variables:
        ..$ linear_time_per_pix: num [1:2000] -21.6 -21.7 -22.5 -21.6 -21.7 ...
        ..$ x_component_number : int [1:2000] 8 8 4 16 8 2 4 4 4 1 ...
        ..- attr(*, "terms")=Classes 'terms', 'formula' length 3 linear_time_per_pix ~ x_component_number
        .. .. ..- attr(*, "variables")= language list(linear_time_per_pix, x_component_number)
        .. .. ..- attr(*, "factors")= int [1:2, 1] 0 1
        .. .. .. ..- attr(*, "dimnames")=List of 2
        .. .. .. .. ..$ : chr [1:2] "linear_time_per_pix" "x_component_number"

...
#+RESULTS:
[[file:/tmp/babel-195179TF/figure19517USQ.png]]
...
#+RESULTS:
[[file:/tmp/babel-195179TF/figure19517I7o.png]]
...
** 2016-02-16
   ...
   - Send to grenoble:
     #+begin_src sh :results output :exports both :tangle scripts/send_to_grenoble.sh
       BASE="$PWD/.."
       ssh squinitomasnada@grid5000.fr:~/grenoble 'mkdir -p boast'
       ...
       rsync -avzP --exclude '.git' $BASE/scripts squinitomasnada@access.grid5000.fr:~/grenoble/boast
     #+end_src
   - Send to nodes:
   ...
   - Install BOAST and run Bruteforce on Adonis:
       #+begin_src sh :results output :exports both :tangle scripts/bruteforce_adonis.sh
         ...
         DATAFOLD="$DATADIR/$DATAFOLD"
         BKUP=`date +%H_%M_%S`
         DATAFOLD2="$DATAFOLD/$BKUP"
         mkdir -p $DATAFOLD
         mkdir -p $DATAFOLD2
         INFO_NAME="Info"
         DATA_FILE="Data"
         INFO_FILE="$DATAFOLD2/$INFO_NAME${BKUP}.org"
         ...
         OPTIMIZER_LOG_FILE=$DATA_FILE OPTIMIZER_LOG=true ruby Laplacian.rb
         mv $DATA_FILE'.yaml' $DATAFOLD2
         mv $DATA_FILE'_parameters.yaml' $DATAFOLD2 
       #+end_src
 
   - Here are some of the result obtained on different execution on
     adonis platforms:
     - [[file:data/2016_02_19/15_32_21_adonis-5/Info15_32_21.org][Adonis-5]] 15:32:21
       #+BEGIN_SRC 
       ...
       #+END_SRC
     - [[file:data/2016_02_19/15_23_23_adonis-9/Info15_23_23.org][Adonis-9]] 15:23:23
       #+BEGIN_SRC 
       ...
       #+END_SRC
     - [[file:data/2016_02_19/15_42_14_adonis-6/Info15_42_14.org][Adonis-6]] 15:42:14
       #+BEGIN_SRC 
       ...
       #+END_SRC
     - [[file:data/2016_02_19/15_51_36_adonis-2/Info15_51_36.org][Adonis-2]] 15:51:36
       #+BEGIN_SRC 

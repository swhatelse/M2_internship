...
***** Evolution of the mean is different from the one the extreme values
     ...
     The following objects are masked _by_ .GlobalEnv:
         ...
         temporary_size, vector_length, x_component_number,
         y_component_number
      x_component_number vector_length  y_component_number temporary_size
      Min.   : 1.0       Min.   : 1.0   Min.   :1.00       Min.   :2     
      1st Qu.: 2.0       1st Qu.: 2.0   1st Qu.:1.75       1st Qu.:2     
...
#+end_example
     ...
     - Knowing what should be the value of y_component_number and
       ...
       #+RESULTS:
       [[file:/tmp/babel-6757t23/figure6757_tv.png]]
     - Another view of the impact of x_component_number showing the
       ...
       #+RESULTS:
       [[file:/tmp/babel-6757t23/figure6757M41.png]]
...
***** Weighted regression
     ...
     - 
         ...
         #+RESULTS:
         [[file:/tmp/babel-6757t23/figure6757M_p.png]]
       ...
       #+RESULTS:
       [[file:/tmp/babel-6757t23/figure6757LFX.png]]
...
****** Brute force
       ...
       - 5-percentiles ~ minimum \to Jain's book
         ...
         #+begin_src R :results output graphics :file (org-babel-temp-file "figure" ".png") :exports both :width 700 :height 700 :session
           library(ggplot2)
           library(plyr)
           df <- read.csv("/tmp/test.csv",strip.white=T,header=T)
         ...
         #+RESULTS:
         [[file:/tmp/babel-6757t23/figure6757afT.png]]
         
         - How do we know the regression is correct?
           #+begin_src R :results output :session :exports both
             library("quantreg")
             df <- read.csv("/tmp/test.csv",strip.white=T,header=T)
             regq = rq(data=df, formula = time_per_pixel ~ x_component_number + I(1/x_component_number), tau=.05)
             regq;
             summary(regq)
           #+end_src
...
#+end_example
          ...
          #+begin_src R :results output :session :exports both
           ...
           #+RESULTS:
           [[file:/tmp/babel-6757t23/figure6757_JA.png]]
           ...
           #+RESULTS:
           [[file:/tmp/babel-6757t23/figure6757A9e.png]]
                 ...
                 for(v in vector_length_values){
                     for(l in lws_values) {
                         for(s in temporary_sizes_values){
                             x_component_number[length(x_component_number)+1] <- y * x

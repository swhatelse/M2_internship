...
***** Quantiles regression
       ...
       #+RESULTS:
==      
       - 5-percentiles ~ minium \to Jain's book
         #+begin_src R :results output graphics :file (org-babel-temp-file "figure" ".png") :exports both :width 600 :height 400 :session
           library(ggplot2)
           library(plyr)
           df <- read.csv("/tmp/test.csv",strip.white=T,header=T)
         ...
         #+RESULTS:
         [[file:/tmp/babel-6851fTT/figure6851vss.png]]

         #+begin_src R :results output graphics :file (org-babel-temp-file "figure" ".png") :exports both :width 900 :height 400 :session
           library(ggplot2)
           library(plyr)
           df <- read.csv("/tmp/test.csv",strip.white=T,header=T)
         ...
         #+RESULTS:
         [[file:/tmp/babel-6851fTT/figure6851vBJ.png]]
       ...
       - Let's try with a more complex case
          ...
          #+RESULTS:
          [[file:/tmp/babel-4402ze1/figure44023Kg.png]]
         ...
         #+end_src
          ...
          #+RESULTS:
         [[file:/tmp/babel-5932xE4/figure5932aXw.png]]
...
****** Testing x_component_number
      ...
      #+RESULTS:
      [[file:/tmp/babel-6851fTT/figure6851WnP.png]]
...
****** Hierarchic
    ...
    :   objet 'x_component_number' introuvable

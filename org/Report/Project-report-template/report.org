...
**** 
    ...
    By doing this we achieved a speedup of x1.51 on the worst case
    which gives a slowdown of x1.395 compare to the best solution of
    the entire search space which is very close to GA.

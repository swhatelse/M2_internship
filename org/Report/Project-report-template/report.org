...
improvement can be made and evaluating the quality of the solution complicated.
...
every time close to optimal solutions. 
\end{abstract}
\abstractintoc
...
** Case study
   ...
   #+END_SRC
   #+LaTeX: \label{lst:kernel_code}\caption{Example of kernel code version generated by BOAST} \end{figure}\clearpage
...
*** 
    ...
    2. Setting vector length and lws y and pruning the

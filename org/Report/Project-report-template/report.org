...
** TODO Differences between regression of expectation and quantile regression
...
*** Linear regression of expectation: limitations
****                                                               :noexport:
   #+begin_src sh :results output :exports none
       ruby ../../../scripts/format_data.rb ../../../data/2016_03_11/pilipili2/19_13_54/Data19_13_54_linear.yaml
   #+end_src
...
****   
   ...
   \caption{\label{fig:good_prediction}Non-uniform noise and the minimum does not follow the evolution of the mean}
   \end{minipage}
   \end{figure}
   #+END_LaTeX

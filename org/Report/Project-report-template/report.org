...
** Case study
   ...
   this work is organized by specifying by tilling.
   There are also two parameters that are important and need to take
   into account in any kernel are the number of threads in work group
   and the organization of the threads in the work group.
* Experiments
* Conclusion

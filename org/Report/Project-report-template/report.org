...
* State of the art
* Methods
  In order for this work to be usefull for someone else we used
  literate programming, we kept track about everything we did in
  laboratory which is available on github with all the data used.
* Contribution
** Case study

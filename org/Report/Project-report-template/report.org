...
** State of the art
   - Atlas \to small search space \to exhaustive search
*** Exploiting the knowledge of the problem
****    
*** Without knowledge   
   - Problem too complex \to no geomerty
   - Random search
   - Genetic Algo
*** Our goal
...
*** Why linear regression is not suited
    - Heteroscedasticity
    - Not gaussian noise and noise is not the same at each point
    - Express general tendency of the impact of factors
    - But miss some interactions?

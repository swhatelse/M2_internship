...
*** Principle
   ...
   any tendency points should be choosen such way that provide a good
...
*** Screening design
    ...
    each other. It samples only the low and high value of the
    ...
    space we only have at most about 32 points.

...
** Problem analysis
  ...
  testing all the combinations (i.e, 2⁵⁰⁰ ~ 10⁵⁰ combinations) to find
...
**** 
   ...
   function\ref{convex_function}. But these hypothesis are not
   necessarily true. The objective function may not be convex
   \ref{non_convex_function}, hence with many local optimum and a
   ...
   inefficient\ref{non_smooth_function}. The auto-tuning problem
   combines all these characteristics\ref{auto_tuning_function}.     

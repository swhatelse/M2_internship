...
*** Explanation of LM worst case
    
*** Why LM and RQ never find the best solution
...
*** Model Optimization [0/2]
   ...
   However \to Non-convex optimization 
     ...
     - Gradient descent + Barrier approach \to not enough time to implement
...
** TODO Model choice, refinement and pruning decision              :noexport:

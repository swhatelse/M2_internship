...
**** 
    ...
    search space is
    discrete\ref{fig:search_space_3d_constrained2}. Hence classical 
    ...
    constraints and using rounding\ref{fig:search_space_3d_constrained1},
    we could use a barrier approach\ref{fig:search_space_3d_barrier} in
    order to guide the optimization method in feasible regions and we

...
**** 
     ...
     #+RESULTS:
     [[file:/tmp/babel-3574D5O/figure3574Mej.png]]
...
**** 
    ...
    approximately the wanted number of points we need to aks more
    points but we can not end up with the exact number of
    points. Finally in our case, the random sampling provided the same
    covering space capability and we could obtain exactly the wanted

...
*** Machine learning
   ...
   combinations on a platform to estimate performances on other
   platforms. This allows them to find interesting part of the search
   ...
   combination between intel CPU and IBM Power but it fails with to
   dissimilar platforms like with ARM in their case. 

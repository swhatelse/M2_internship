...
** TODO Case study
   ...
   1. Vector length allows to specify the size of the
      ...
      different vector size supported by OpenCL.
   ...
   6. The two last parameters allow to tune two OpenCL/Cuda
      ...
      work size y (lws y) determines how the threads are organized in
      a block and represent the number of threads in the y-axis. These
      parameters have an impact on the scheduling, the data sharing
      and the occupancy of the compute units. Thus they can lead to

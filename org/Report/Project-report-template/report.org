...
*** 
    ...
    values and the real ones, the more they are correlated the more
    accurate the model. The figure\ref{fig:bad_prediction} shows the
    ...
    detected easily by the user and thus take correct decision. The

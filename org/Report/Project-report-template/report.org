...
** HPC architectures
  ...
  *Pipelining* is another kind of parallelism in which the treatment of
  ...
  it. For example conditions are a disaster because prevent this kind
  of things *Instruction Level Parallelism* is a mechanism that can
  change the order of the instructions to have a better overlapping of the

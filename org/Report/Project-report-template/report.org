...
*** Compiling
*** BOAST
** State of the art on Autotuning
      ...
      - Gradient descent: ferrari, a priori = local, geometry, convexity.
        - Issues: 
          - partly wrong hypothesis (geometry, convexity): simulated
            ...
            sense)
          - experimental estimation: surrogates, etc. *local* approximation
...
*** Linear regression of expectation: why it cannot work and how it can be circumvented    - Assumptions:

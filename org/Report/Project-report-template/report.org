...
***                                                                :noexport:
    #+begin_src R :results output graphics :file ./img/results_hist.pdf :exports none :width 600 :height 800 :session
      df_all_methods <- read.csv("../../../data/2016_04_08/pilipili2/18_08_24/all_search.csv", strip.white=T, header=T)  
      library(ggplot2)
      library(plyr)
      ...
      ggplot(df_all_methods, aes(speedup)) + 
          facet_grid(method~.) +
          ...
          ggtitle("") + coord_cartesian(xlim=c(.9,3))
    #+end_src
...
*** 
    ...
    the search space. It starts with 105 random points and adds 5
   ...
   #+END_LaTeX
    ...
    | LM      | 1.010 | 32.060 | 1.445 |  1.080 |       119 |
    | RQ      | 1.010 | 30.890 | 1.432 |  1.073 |       119 |
...
** Linear regression of expectation: why it cannot work and how it can be circumvented
   ...
   the case, and in our example we can see that the variability is not
   the same at each factor level. 

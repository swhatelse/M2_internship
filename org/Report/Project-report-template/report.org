...
*** 
    ...
    step of the optimization process. Indeed, vector length and lws y
    are the first factors we fixed in our strategy. Instead of
    predicting that the best size of vector is 1 the model predicted a size 

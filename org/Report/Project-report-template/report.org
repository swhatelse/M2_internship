...
**** 
   ...
   combines all these characteristics (see Figure\ref{fig:auto_tuning_function}).     
...
*** 
   ...
   \caption{\label{fig:combination_distribution}These figures presents the slowdown of the combination 
    of the entire search space. The left figure is a global view and the right figure focuses
...
*** 
   ...
   \end{minipage}
   \caption{\label{fig:qr-example}\textbf{Linear regression vs quantile regression}: The 
    classical linear regression fails to predict the evolution of the minimum when the error 
    law is not uniform while quantile is more suited to this.}
   \end{figure}
   #+END_LaTeX

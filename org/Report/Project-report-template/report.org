...
** Case study
   ...
   #+END_SRC
   #+LaTeX: \label{lst:boast_code}\caption{BOAST code generating the Laplacian kernel} \end{figure}\clearpage
   ...
   #+END_SRC
   #+LaTeX: \label{lst:kernel_code}\caption{Example of a Laplacian kernel version generated by BOAST} \end{figure}\clearpage

...
*** 
    ...
    most of the time it converges to the same solution which
    has a slowdown of 1.2%. With a mean slowdown of 1.4% it is 6.7
    times better than GA. It only failed one time giving a solutions
    with a slowdown of 21.4% which is still better than worst solution
    of the GA.

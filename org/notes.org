...
*** Bibtex
 ...
 keywords = {BLAS, code generation, high performance, linear algebra, optimization, tuning},
    ...
    #+END_SRC
** TODO [ [[file:~/Dropbox/IMAG/M2/Stage/BOAST/papers/pluto.pdf][pluto]] ] A Practical Automatic Polyhedral Parallelizer and Locality Optimizer
*** Summary
  - For loop transformation \to nested loop parallelization
    Generate OpenMP parallel code.
  - Based on polyhedric model.
*** Link
    http://drona.csa.iisc.ernet.in/~uday//publications/uday-pldi08.pdf
*** Bibtex
    #+BEGIN_SRC bibtex :tangle ./biblio.bib
...
*** Bibtex
    ...
    #+END_SRC
** TODO [ [[file:~/Dropbox/IMAG/M2/Stage/BOAST/papers/construction%20and%20use%20of%20linear%20regression%20models%20for%20processor%20performance%20analysis.pdf][construction and use of linear regression models for processor performance analysis]] ] Construction and use of linear regression models for processor performance analysis
** TODO [ [[file:~/Dropbox/IMAG/M2/Stage/BOAST/papers/QReco.pdf][QReco]] ]A gentle introduction to quantile regression for ecologists
*** Bibtex
    #+BEGIN_SRC bibtex :tangle ./biblio.bib
...
*** Bibtex
    #+BEGIN_SRC bibtex :tangle ./biblio.bib
      @inproceedings{videau:hal-00953119,
        TITLE = {{BOAST: Bringing Optimization through Automatic Source-to-Source Tranformations}},
        AUTHOR = {Videau, Brice and Marangozova-Martin, Vania and Cronsioe, Johan},
        URL = {https://hal.inria.fr/hal-00953119},
    ...
    #+END_SRC
** Presentation Arthur CHARPENTIER
*** Bibtex
    #+BEGIN_SRC bibtex :tangle ./biblio.bib
          @unpublished{LectureQR,
        Author = {Arthur, Charpentier},
        Institution = {UQAM},
        Howpublished = {Lecture},
        Year = {2012},
        Title = {Quantiles and related stuff},
        Note  = {http://freakonometrics.free.fr/mcgill-r.pdf}
      }
    #+END_SRC
** TODO [ [[file:~/Dropbox/IMAG/M2/Stage/BOAST/papers/icl-utk-902-2016.pdf][icl-utk-902-2016]] ] Search Space Generation and Pruning System for Autotuners
*** Summary
*** Link
    http://www.icl.utk.edu/sites/icl/files/publications/2016/icl-utk-902-2016.pdf
** TODO  [ [[file:~/Dropbox/IMAG/M2/Stage/BOAST/papers/beast_tuning%20_cholesky.pdf][beast_tuning _cholesky]] ] Implementation and Tuning of Batched Cholesky Factorization and Solve for NVIDIA GPUs
*** Link
    https://www.computer.org/csdl/trans/td/preprint/07275187.pdf

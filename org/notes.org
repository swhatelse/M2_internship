...
** Overview
   ...
   possible to try every possiblity, it exists methods to find good
   optimization parameters using only part of the search space.

   For this genetic algorithms works reasonnably well, they
